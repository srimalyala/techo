...
@XmlRootElement(name = "VariationSummary", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
public class VariationSummary {

    @XmlElement(name = "LowestPrice", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
    protected Price lowestPrice;
    @XmlElement(name = "HighestPrice", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
