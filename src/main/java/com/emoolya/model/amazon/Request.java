...
@XmlRootElement(name = "Request", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
public class Request {

    @XmlElement(name = "IsValid", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
    protected String isValid;
    @XmlElement(name = "BrowseNodeLookupRequest", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
    protected BrowseNodeLookupRequest browseNodeLookupRequest;
    @XmlElement(name = "ItemSearchRequest", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
    protected ItemSearchRequest itemSearchRequest;
    @XmlElement(name = "ItemLookupRequest", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
    protected ItemLookupRequest itemLookupRequest;
    @XmlElement(name = "SimilarityLookupRequest", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
    protected SimilarityLookupRequest similarityLookupRequest;
    @XmlElement(name = "CartGetRequest", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
    protected CartGetRequest cartGetRequest;
    @XmlElement(name = "CartAddRequest", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
    protected CartAddRequest cartAddRequest;
    @XmlElement(name = "CartCreateRequest", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
    protected CartCreateRequest cartCreateRequest;
    @XmlElement(name = "CartModifyRequest", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
    protected CartModifyRequest cartModifyRequest;
    @XmlElement(name = "CartClearRequest", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
