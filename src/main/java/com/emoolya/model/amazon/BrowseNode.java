...
@XmlRootElement(name = "BrowseNode", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
public class BrowseNode {

    @XmlElement(name = "BrowseNodeId", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
    protected String browseNodeId;
    @XmlElement(name = "Name", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
    protected String name;
    @XmlElement(name = "IsCategoryRoot", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
    protected Boolean isCategoryRoot;
    @XmlElement(name = "Properties", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
    protected BrowseNode.Properties properties;
    @XmlElement(name = "Children", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
    protected BrowseNode.Children children;
    @XmlElement(name = "Ancestors", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
    ...
    @XmlElement(name = "TopItemSet", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
    ...
    public static class Ancestors {
        ...
        @XmlElement(name = "BrowseNode", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01", required = true)
    ...
    public static class Properties {
        ...
        @XmlElement(name = "Property", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01", required = true)
