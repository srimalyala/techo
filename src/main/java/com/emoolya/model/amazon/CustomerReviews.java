...
@XmlRootElement(name = "CustomerReviews", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
public class CustomerReviews {

    @XmlElement(name = "IFrameURL", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
    protected String iFrameURL;
    @XmlElement(name = "HasReviews", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
