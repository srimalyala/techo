...
@XmlRootElement(name = "Collections", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
public class Collections {

    @XmlElement(name = "Collection", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
    ...
    public static class Collection {
        ...
        @XmlElement(name = "CollectionSummary", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
        protected Collections.Collection.CollectionSummary collectionSummary;
        @XmlElement(name = "CollectionParent", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
        protected Collections.Collection.CollectionParent collectionParent;
        @XmlElement(name = "CollectionItem", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
        ...
        public static class CollectionSummary {
            ...
            @XmlElement(name = "LowestListPrice", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
            protected Price lowestListPrice;
            @XmlElement(name = "HighestListPrice", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
            protected Price highestListPrice;
            @XmlElement(name = "LowestSalePrice", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
            protected Price lowestSalePrice;
            @XmlElement(name = "HighestSalePrice", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
