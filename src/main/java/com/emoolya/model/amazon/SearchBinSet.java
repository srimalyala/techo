...
@XmlRootElement(name = "SearchBinSet", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
public class SearchBinSet {

    @XmlElement(name = "Bin", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
