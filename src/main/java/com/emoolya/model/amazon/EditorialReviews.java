...
@XmlRootElement(name = "EditorialReviews", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
public class EditorialReviews {

    @XmlElement(name = "EditorialReview", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
