...
@XmlRootElement(name = "LoyaltyPoints", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
public class LoyaltyPoints {

    @XmlElement(name = "Points", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
    @XmlSchemaType(name = "nonNegativeInteger")
    protected BigInteger points;
    @XmlElement(name = "TypicalRedemptionValue", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
