...
@XmlRootElement(name = "SimilarViewedProducts", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
public class SimilarViewedProducts {

    @XmlElement(name = "SimilarViewedProduct", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01", required = true)
