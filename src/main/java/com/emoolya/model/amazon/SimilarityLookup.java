...
@XmlRootElement(name = "SimilarityLookup", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
public class SimilarityLookup {

    @XmlElement(name = "MarketplaceDomain", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
    protected String marketplaceDomain;
    @XmlElement(name = "AWSAccessKeyId", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
    ...
    @XmlElement(name = "Validate", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
    protected String validate;
    @XmlElement(name = "XMLEscaping", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
    protected String xmlEscaping;
    @XmlElement(name = "Shared", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
