...
@XmlRootElement(name = "Offer", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
public class Offer {

    @XmlElement(name = "Merchant", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
    protected Merchant merchant;
    @XmlElement(name = "OfferAttributes", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
    protected OfferAttributes offerAttributes;
    @XmlElement(name = "OfferListing", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
    protected List<OfferListing> offerListing;
    @XmlElement(name = "LoyaltyPoints", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
    protected LoyaltyPoints loyaltyPoints;
    @XmlElement(name = "Promotions", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
