...
@XmlRootElement(name = "ImageSet", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
public class ImageSet {

    @XmlElement(name = "SwatchImage", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
    ...
    @XmlElement(name = "ThumbnailImage", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
    protected Image thumbnailImage;
    @XmlElement(name = "TinyImage", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
