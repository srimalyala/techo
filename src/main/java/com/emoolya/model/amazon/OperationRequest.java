...
@XmlRootElement(name = "OperationRequest", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
public class OperationRequest {

    @XmlElement(name = "HTTPHeaders", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
    protected HTTPHeaders httpHeaders;
    @XmlElement(name = "RequestId", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
    protected String requestId;
    @XmlElement(name = "Arguments", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
    protected Arguments arguments;
    @XmlElement(name = "Errors", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
    protected Errors errors;
    @XmlElement(name = "RequestProcessingTime", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
