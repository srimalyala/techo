...
@XmlRootElement(name = "Tracks", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
public class Tracks {

    @XmlElement(name = "Disc", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01", required = true)
    ...
    public static class Disc {
        ...
        @XmlElement(name = "Track", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01", required = true)
