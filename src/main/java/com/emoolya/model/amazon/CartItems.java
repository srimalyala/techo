...
@XmlRootElement(name = "CartItems", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
public class CartItems {
    ...
    @XmlElement(name = "CartItem", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01", required = true)
