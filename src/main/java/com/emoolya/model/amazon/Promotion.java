...
@XmlRootElement(name = "Promotion", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
public class Promotion {

    @XmlElement(name = "Summary", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
    ...
    public static class Summary {
        ...
        @XmlElement(name = "PromotionId", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01", required = true)
        protected String promotionId;
        @XmlElement(name = "Category", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
        protected String category;
        @XmlElement(name = "StartDate", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
        protected String startDate;
        @XmlElement(name = "EndDate", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
        protected String endDate;
        @XmlElement(name = "EligibilityRequirementDescription", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
        protected String eligibilityRequirementDescription;
        @XmlElement(name = "BenefitDescription", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
        protected String benefitDescription;
        @XmlElement(name = "TermsAndConditions", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
