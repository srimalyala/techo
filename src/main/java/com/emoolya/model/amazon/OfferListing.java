...
@XmlRootElement(name = "OfferListing", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
public class OfferListing {

    @XmlElement(name = "OfferListingId", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
    protected String offerListingId;
    @XmlElement(name = "Price", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
    protected Price price;
    @XmlElement(name = "SalePrice", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
    protected Price salePrice;
    @XmlElement(name = "AmountSaved", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
    protected Price amountSaved;
    @XmlElement(name = "PercentageSaved", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
    ...
    @XmlElement(name = "AvailabilityAttributes", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
    protected OfferListing.AvailabilityAttributes availabilityAttributes;
    @XmlElement(name = "IsEligibleForSuperSaverShipping", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
    protected Boolean isEligibleForSuperSaverShipping;
    @XmlElement(name = "IsEligibleForPrime", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
    ...
    public static class AvailabilityAttributes {
        ...
        @XmlElement(name = "AvailabilityType", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
        protected String availabilityType;
        @XmlElement(name = "IsPreorder", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
        protected Boolean isPreorder;
        @XmlElement(name = "MinimumHours", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
        protected BigInteger minimumHours;
        @XmlElement(name = "MaximumHours", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
