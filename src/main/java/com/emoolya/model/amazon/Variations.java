...
@XmlRootElement(name = "Variations", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
public class Variations {

    @XmlElement(name = "TotalVariations", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
    @XmlSchemaType(name = "nonNegativeInteger")
    protected BigInteger totalVariations;
    @XmlElement(name = "TotalVariationPages", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
    @XmlSchemaType(name = "nonNegativeInteger")
    protected BigInteger totalVariationPages;
    @XmlElement(name = "VariationDimensions", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
