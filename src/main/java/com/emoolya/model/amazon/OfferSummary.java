...
@XmlRootElement(name = "OfferSummary", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
public class OfferSummary {

    @XmlElement(name = "LowestNewPrice", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
    protected Price lowestNewPrice;
    @XmlElement(name = "LowestUsedPrice", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
    protected Price lowestUsedPrice;
    @XmlElement(name = "LowestCollectiblePrice", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
    protected Price lowestCollectiblePrice;
    @XmlElement(name = "LowestRefurbishedPrice", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
    protected Price lowestRefurbishedPrice;
    @XmlElement(name = "TotalNew", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
    protected String totalNew;
    @XmlElement(name = "TotalUsed", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
    protected String totalUsed;
    @XmlElement(name = "TotalCollectible", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
    protected String totalCollectible;
    @XmlElement(name = "TotalRefurbished", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
