...
@XmlRootElement(name = "Bin", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
public class Bin {

    @XmlElement(name = "BinName", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01", required = true)
    protected String binName;
    @XmlElement(name = "BinItemCount", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01", required = true)
    @XmlSchemaType(name = "positiveInteger")
    protected BigInteger binItemCount;
    @XmlElement(name = "BinParameter", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
