...
@XmlRootElement(name = "SearchResultsMap", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
public class SearchResultsMap {

    @XmlElement(name = "SearchIndex", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01", required = true)
    ...
    public static class SearchIndex {
        ...
        @XmlElement(name = "IndexName", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01", required = true)
        protected String indexName;
        @XmlElement(name = "Results", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
        @XmlSchemaType(name = "nonNegativeInteger")
        protected BigInteger results;
        @XmlElement(name = "Pages", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
        @XmlSchemaType(name = "nonNegativeInteger")
        protected BigInteger pages;
        @XmlElement(name = "CorrectedQuery", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
        protected CorrectedQuery correctedQuery;
        @XmlElement(name = "RelevanceRank", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01", required = true)
