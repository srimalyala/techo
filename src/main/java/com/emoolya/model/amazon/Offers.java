...
@XmlRootElement(name = "Offers", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
public class Offers {

    @XmlElement(name = "TotalOffers", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
    @XmlSchemaType(name = "nonNegativeInteger")
    protected BigInteger totalOffers;
    @XmlElement(name = "TotalOfferPages", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
    @XmlSchemaType(name = "nonNegativeInteger")
    protected BigInteger totalOfferPages;
    @XmlElement(name = "MoreOffersUrl", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
    protected String moreOffersUrl;
    @XmlElement(name = "Offer", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
