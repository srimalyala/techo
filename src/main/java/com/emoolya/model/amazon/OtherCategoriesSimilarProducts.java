...
@XmlRootElement(name = "OtherCategoriesSimilarProducts", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
public class OtherCategoriesSimilarProducts {

    @XmlElement(name = "OtherCategoriesSimilarProduct", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01", required = true)
