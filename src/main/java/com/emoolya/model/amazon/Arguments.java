...
@XmlRootElement(name = "Arguments", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
public class Arguments {

    @XmlElement(name = "Argument", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01", required = true)
