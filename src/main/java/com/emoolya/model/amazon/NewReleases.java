...
@XmlRootElement(name = "NewReleases", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
public class NewReleases {

    @XmlElement(name = "NewRelease", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01", required = true)
