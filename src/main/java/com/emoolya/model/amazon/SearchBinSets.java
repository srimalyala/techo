...
@XmlRootElement(name = "SearchBinSets", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
public class SearchBinSets {

    @XmlElement(name = "SearchBinSet", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
