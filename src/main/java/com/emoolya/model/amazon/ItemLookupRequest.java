...
@XmlType(name = "ItemLookupRequest", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01", propOrder = {
    "condition",
    "idType",
    "merchantId",
    "itemId",
...
public class ItemLookupRequest {
    ...
    @XmlElement(name = "IdType", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
    protected String idType;
    @XmlElement(name = "MerchantId", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
    protected String merchantId;
    @XmlElement(name = "ItemId", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
    ...
    @XmlElement(name = "VariationPage", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
