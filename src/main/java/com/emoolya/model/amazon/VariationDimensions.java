...
@XmlRootElement(name = "VariationDimensions", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
public class VariationDimensions {

    @XmlElement(name = "VariationDimension", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01", required = true)
