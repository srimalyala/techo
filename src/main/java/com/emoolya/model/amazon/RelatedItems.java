...
@XmlRootElement(name = "RelatedItems", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
public class RelatedItems {

    @XmlElement(name = "Relationship", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
    protected String relationship;
    @XmlElement(name = "RelationshipType", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
    protected String relationshipType;
    @XmlElement(name = "RelatedItemCount", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
    @XmlSchemaType(name = "nonNegativeInteger")
    protected BigInteger relatedItemCount;
    @XmlElement(name = "RelatedItemPageCount", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
    @XmlSchemaType(name = "nonNegativeInteger")
    ...
    @XmlElement(name = "RelatedItem", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
