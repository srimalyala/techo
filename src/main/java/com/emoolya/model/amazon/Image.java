...
@XmlType(name = "Image", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01", propOrder = {
    "url",
    "height",
    "width",
    "isVerified"
...
public class Image {
    ...
    @XmlElement(name = "URL", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01", required = true)
    protected String url;
    @XmlElement(name = "Height", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01", required = true)
    protected DecimalWithUnits height;
    @XmlElement(name = "Width", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01", required = true)
    protected DecimalWithUnits width;
    @XmlElement(name = "IsVerified", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
