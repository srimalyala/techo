...
@XmlRootElement(name = "SavedForLaterItems", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
public class SavedForLaterItems {
    ...
    @XmlElement(name = "SavedForLaterItem", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01", required = true)
