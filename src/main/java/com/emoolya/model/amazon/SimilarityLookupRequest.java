...
@XmlType(name = "SimilarityLookupRequest", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01", propOrder = {
    "condition",
    "itemId",
    "merchantId",
    "responseGroup",
...
public class SimilarityLookupRequest {
    ...
    @XmlElement(name = "SimilarityType", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
