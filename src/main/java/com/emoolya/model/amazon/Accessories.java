...
@XmlRootElement(name = "Accessories", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
public class Accessories {

    @XmlElement(name = "Accessory", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01", required = true)
