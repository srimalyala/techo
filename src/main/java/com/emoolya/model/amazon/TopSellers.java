...
@XmlRootElement(name = "TopSellers", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
public class TopSellers {

    @XmlElement(name = "TopSeller", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01", required = true)
