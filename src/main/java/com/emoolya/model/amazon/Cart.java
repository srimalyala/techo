...
@XmlRootElement(name = "Cart", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
public class Cart {

    @XmlElement(name = "Request", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
    protected Request request;
    @XmlElement(name = "CartId", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01", required = true)
    protected String cartId;
    @XmlElement(name = "HMAC", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01", required = true)
    protected String hmac;
    @XmlElement(name = "URLEncodedHMAC", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01", required = true)
    protected String urlEncodedHMAC;
    @XmlElement(name = "PurchaseURL", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
    protected String purchaseURL;
    @XmlElement(name = "MobileCartURL", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
    protected String mobileCartURL;
    @XmlElement(name = "SubTotal", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
    protected Price subTotal;
    @XmlElement(name = "CartItems", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
    protected CartItems cartItems;
    @XmlElement(name = "SavedForLaterItems", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
    ...
    @XmlElement(name = "TopSellers", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
    protected TopSellers topSellers;
    @XmlElement(name = "NewReleases", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
    protected NewReleases newReleases;
    @XmlElement(name = "SimilarViewedProducts", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
    protected SimilarViewedProducts similarViewedProducts;
    @XmlElement(name = "OtherCategoriesSimilarProducts", namespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01")
